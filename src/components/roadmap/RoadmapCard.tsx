          ...
          <div className="space-y-6">
            ...
            {module.resources.readings.length > 0 && (
              <div className="space-y-2">
                ...
                <div className="ml-6">
                  {module.resources.readings.map((reading, idx) =>
                    renderResourceLink(reading),
                  )}
                </div>
              </div>
            )}
            ...
            {module.resources.exercises.length > 0 && (
              <div className="space-y-2">
                ...
                <div className="ml-6">
                  {module.resources.exercises.map((exercise, idx) =>
                    renderResourceLink(exercise),
                  )}
                </div>
              </div>
            )}
